						...
						<?php echo form_open('login/cek_login','class="form-horizontal"'); ?> 
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="email" type="email" class="form-control input-lg" autofocus  required/>
							...
							<div class="form-group mb-lg">
								<div class="clearfix">
									...
									<a href="<?php echo site_url('forgotpass')?>" class="pull-right">Lost Password?</a>
								</div>
								<div class="input-group input-group-icon">
                            ...
                            <hr>
							<p class="text-center">Don't have an account yet? <a href="<?php echo site_url('daftar')?>">Sign Up!</a>
						</form>
					</div>
				</div>
